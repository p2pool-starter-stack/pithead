...
# _gauge_series is re-exported unused so web/views/worker_detail.py's existing import keeps resolving.
...
# The XvB/earnings/badges cluster lives in web/views/xvb_views.py (#1105). views.py stays the facade:
# build_state assembles these sections, build_hashrate uses the low-hashrate title, and
# service/notify/telegram_commands.py imports build_badges from here.
...
SHELL_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), "templates", "index.html")
_SHELL_CACHE = None
_SHELL_MTIME = 0
