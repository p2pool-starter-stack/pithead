...
class DataSetupMixin:
    def __init__(self, state_manager, proxy_client, xvb_client):
        ...
        # A restore carries the source machine's release (#2626). Until the gate releases on this
        # machine's own chains, the restore marker overrides it, across restarts too.
