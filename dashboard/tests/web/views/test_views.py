"""Unit tests for the dashboard view/presentation layer (mining_dashboard/web/views/views.py).
...
class TestBuildState:
    ...
    def test_update_badge_never_advertises_the_running_version(
        ...
        monkeypatch.setattr(
            "mining_dashboard.web.views.views.resolve_version",
...
class TestVisibleUpdate:
    ...
    def test_last_update_falls_back_to_now_when_timestamp_missing(self, _data, _state_mgr):
        ...
        with patch("mining_dashboard.web.views.views.time.time", return_value=12345.0):
...
class TestEgressTopology:
    ...
    tests/service/network/test_egress.py."""
