"""The header's address block (``web/views/header.py``): the hostname/IP line and the .onion under it.

Split out of ``test_views.py`` when ``host_display_addr`` moved to ``web/views/header.py`` alongside the
