...
``tor.auto_heal`` is on (``service/health/tor_heal.py:63``, ``:130-134``). That is a real outbound call,
...
from mining_dashboard.service.network.egress import CLEARNET, INACTIVE, TOR
