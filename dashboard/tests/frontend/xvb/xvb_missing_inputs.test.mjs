...
test("XvB calculator names every input missing from an unready fresh box (#1960)", () => {
  ...
  assert.match(waiting, /Hashrate Cost<\/p><p[^>]*>needs hashrate/);
  ...
  assert.match(tooSmall, /Hashrate Cost<\/p><p[^>]*>below the lowest tier/);
  assert.match(tooSmall, /Net \(XvB says\)<\/p><p[^>]*>insufficient hashrate/);
