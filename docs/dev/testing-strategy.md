...
| Image invariants: variant stamp, enabled units, watchdog/governor config, unwanted-package absence, dev-keyring refusal | `tests/os/verify-image.sh` (static, no KVM) | build-time ✅ |
