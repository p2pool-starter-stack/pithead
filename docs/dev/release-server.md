...
| Fault injection over SSH: no recorded live evidence | Low-Medium. The faults use the shared SSH/local target wrapper; [#2000](https://github.com/p2pool-starter-stack/pithead/issues/2000) tracks the focused remote quoting, cleanup, and restoration proof. |
