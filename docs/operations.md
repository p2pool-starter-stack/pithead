...
RPC is busy, but only while its scan marker, written at each start, is less than 24 hours old. After that, a silent wallet is unhealthy; `PAYOUT_SCAN_GRACE_SEC` defaults to 86400
