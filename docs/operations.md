...
the validated proxy token, wallet RPC and database passwords, dashboard login hash and fingerprint,
and Tor identities are retained exactly from the archived environment.
