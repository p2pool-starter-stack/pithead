...
Releases before the current major ([2.0.0](../CHANGELOG.md#200---2026-09-06) and later,
which stay in [`CHANGELOG.md`](../CHANGELOG.md)). Same [Keep a Changelog](https://keepachangelog.com/en/1.1.0/) format.
