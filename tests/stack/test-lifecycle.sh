...
# Lifecycle suite split at its existing recovery, pull policy, lock primitive, verb wiring, and
# appliance seams.
...
# shellcheck source=tests/stack/lifecycle/keep-running.sh
source "$HERE/lifecycle/keep-running.sh" || return $?
