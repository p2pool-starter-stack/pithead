...
CVL_COVERED="setup apply render up down restart upgrade status doctor backup restore load-images firstboot-wizard local-miner os-update factory-reset control-run-pending onion-client-key uninstall"
