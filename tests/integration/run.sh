...
RUN_LIFECYCLE=0
RUN_FAULTS=0
FAULT_SSH=0       # #2000: --fault-injection-ssh — run just the fault-injection phase's rx() calls over SSH
FAULT_SSH_DEST="" # …dialing this <user@host>, which e2e.sh supplies (the phase token is bare)
