...
#
#   tests/os/run.sh --image PATH [--keep] [--phase boot|update|install|provision|rig|rigmedia|media|fault|reset|image-upgrade|crossupdate|all]
#
# Phases:
...
#           since #1064; rigmedia added since #2069; image-upgrade added for #2057
#
