...
#
#   tests/os/run.sh --image PATH [--keep] [--phase boot|update|install|provision|rig|media|fault|reset|stack|all]
#
# Phases:
...
#   all     every phase above, in that order — media, fault, reset and stack included since #1064/#2062
#
