...
if (
    for stage in reflink-file reflink-format reflink-mountpoint reflink-mount-loop reflink-verify baseline-compat local-miner-tree local-miner-setup local-miner-unit miner-share baseline-setup; do
