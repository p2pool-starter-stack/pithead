...
restore_fixture_fingerprints() {
    ...
    RESTORE_SOURCE_SECRETS=$(_ssh "grep -E '^(MONERO_NODE_(USERNAME|PASSWORD)|DASHBOARD_AUTH_HASH_B64|DASHBOARD_ONION_CLIENT_PRIVKEY)=' /data/pithead/.env | sha256sum | cut -d' ' -f1") || return 1
