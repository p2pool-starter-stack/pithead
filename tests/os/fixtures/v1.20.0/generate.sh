...
printf '%s\n' "$wallet" >"$out/wallet"
printf '%s\n' 'v1.20.0 signed compose bundle; sha256: 77071195f5e8ef07b68a7bde9db20d30c0e64cfb561280d962d555acc03a6d4b; generated by tests/os/fixtures/v1.20.0/generate.sh' >"$out/PROVENANCE"
