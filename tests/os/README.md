...
that the boot path's files sit where the firmware and GRUB will look. It resolves the registry and
version expressions provisioning uses, then compares the shipped compose after immutable digest pins.
